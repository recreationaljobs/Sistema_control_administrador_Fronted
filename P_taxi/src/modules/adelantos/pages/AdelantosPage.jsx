  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black text-slate-950 md:text-[28px]">
                {esTaxista ? "Mis adelantos" : "Adelantos"}
              </h1>

              <p className="mt-1 max-w-2xl text-sm font-medium text-slate-500 md:text-base">
                {esTaxista
                  ? "Consulta los adelantos asociados a tus jornadas."
                  : "Registra y controla los adelantos otorgados por jornada."}
              </p>
            </div>
          </div>
      ...
      <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-bold text-slate-500">
                {esTaxista ? "Mis adelantos" : "Total adelantos"}
              </p>
        ...
        <div className="rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-50 text-[#C98A00]">
              <Wallet size={28} />
            </div>

            <div>
              <p className="text-sm font-bold text-slate-500">
                {esTaxista ? "Monto adelantado" : "Monto total"}
              </p>

              <h3 className="mt-1 text-xl font-black text-[#C98A00]">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-xs font-bold text-slate-500">
                {adelantosHoy.length} registro(s)
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <h2 className="text-lg font-black text-slate-950">
              {esTaxista ? "Listado de mis adelantos" : "Listado de adelantos"}
            </h2>
